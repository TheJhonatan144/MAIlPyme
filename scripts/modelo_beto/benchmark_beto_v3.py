...
def main() -> None:
    ...
    latency_csv_path = (
        metrics_dir
        / "latencia_individual_beto_v3.csv"
    )
    throughput_csv_path = (
        metrics_dir
        / "throughput_beto_v3.csv"
    )
    resource_csv_path = (
        metrics_dir
        / "monitoreo_recursos_beto_v3.csv"
    )
    summary_json_path = (
        metrics_dir
        / "benchmark_beto_v3.json"
    )
    stability_csv_path = (
        metrics_dir
        / "estabilidad_beto_v3.csv"
    )
    log_path = (
        logs_dir
        / "benchmark_beto_v3.log"
    )
    ...
    latency_plot_path = (
        plots_dir
        / "distribucion_latencia_beto_v3.png"
    )
    throughput_plot_path = (
        plots_dir
        / "throughput_por_batch_beto_v3.png"
    )
    ...
    plt.title(
        "Distribución de latencia individual - BETO MailPyme AI v3"
    )
    ...
    plt.title(
        "Throughput por tamaño de lote - BETO MailPyme AI v3"
    )
