...
def main() -> None:
    ...
    checkpoints_dir = model_root / "checkpoints_beto_v3"
    final_model_dir = model_root / "mailpyme_beto_model_v3"
    ...
    config_path = metrics_dir / "config_entrenamiento_beto_v3.json"
    ...
    if args.mode == "preflight":
        ...
        preflight_path = (
            metrics_dir
            / "preflight_entrenamiento_beto_v3.json"
        )
    ...
    training_summary_path = (
        metrics_dir
        / "resumen_entrenamiento_beto_v3.json"
    )
